        ...
        include: {
            admin: { 
                select: { 
                    ...
                    full_name: true, 
                    email: true,
                    company_name: true,      // Şirket adı
                    company_code: true       // Şirket kodu eklendi
                } 
            }
        }
    });
    ...
    const result = complaints.map(complaint => ({
        ...
        admin: complaint.admin
            ? { 
                ...
                name: complaint.admin.full_name, 
                email: complaint.admin.email,
                ...(complaint.admin.company_name && complaint.admin.company_code
                    ? {
                        company_name: complaint.admin.company_name,
                        company_code: complaint.admin.company_code
                    }
                    : {})
            }
            : null
